...
Ce projet est dédiée à l'analyse structurelle et mathématique des Chaînes de Markov. Il permet d'ingérer un graphe probabiliste, de décomposer ses états, de classifier ses composantes et de générer des visualisations graphiques via Mermaid.
